...
public class FrontendAspect {
    ...
    @Pointcut("execution(public String cn.eyeblue.blog.frontend.*.*Controller.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
